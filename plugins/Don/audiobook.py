...
Thanks = """<b>Thats The End Of Your Audio Book📖, And Thanks for Using this Service</b>"""
...
async def pdf_to_text(bot, message):
 try:
           if message.reply_to_message:
                ...
                txt = await message.reply("ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ.....")
                await message.reply_to_message.download(pdf_path)  
                await txt.edit("ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ꜰɪʟᴇ")
                pdf = open(pdf_path,'rb')
                pdf_reader = PyPDF2.PdfFileReader(pdf) #pdfReaderObject
                await txt.edit("ɢᴇᴛᴛɪɴɢ ɴᴜᴍʙᴇʀ ᴏꜰ ᴘᴀɢᴇꜱ 📖....")
                ...
                await txt.edit("ꜰɪɴᴅɪɴɢ ᴛᴇxᴛ ꜰʀᴏᴍ ᴘᴅꜰ ꜰɪʟᴇ... ")
                ...
                await txt.edit(f"ᴄʀᴇᴀᴛɪɴɢ ʏᴏᴜʀ ᴀᴜᴅɪᴏ ʙᴏᴏᴋ 📖...\n ᴘʟᴇᴀꜱᴇ ᴅᴏɴ'ᴛ ᴅᴏ ᴀɴʏᴛʜɪɴɢ")
              ...
              # Change Voice by editing the Language
                ...
                await txt.edit("ᴛʜᴀɴᴋꜱ ꜰᴏʀ ᴜꜱɪɴɢ ʜᴀʀʟᴇʏ")    
                os.remove(pdf_path)  
                
                
           else :
                await message.reply("ᴘʟᴇᴀꜱᴇ ʀᴇᴘʟʏ ᴛᴏ ᴘᴅꜰ ꜰɪʟᴇ")
